...
" Выводить знак $ при операции замены
...
if exists("*function")
	...
	" запретить использовании сокращенных тегов
...
" сохранять позицию курсора при page up/down
...
nnoremap <silent>,r :call RepairFile()<CR>:echo "DOS characters removed"<CR>
...
if has("menu")
	...
	" меню проверки орфографии
	anoremenu &File.&Spell.&Combined :setlocal spell spelllang=ru,en spelllang?<CR>
	anoremenu &File.&Spell.&Russian :setlocal spell spelllang=ru spelllang?<CR>
	anoremenu &File.&Spell.&English :setlocal spell spelllang=en spelllang?<CR>
